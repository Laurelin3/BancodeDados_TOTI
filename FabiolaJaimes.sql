...
VALUES
 ...
 -- Query #1 (Tem alguns Clientes que são dependentes. Quero que vocês me digam de que clientes eles são dependentes. Por exemplo “Filho A” é dependente de qual outro cliente?)
 ...
 -- Query #2 (Quais foram as 5 contas que: Mais fizeram transações)
 ...
 -- Query #3 (Quais foram as 5 contas que: Menos fizeram transações)
 ...
 -- Query #4 (Tivemos uma perda de dados e não sabemos qual é o saldo de cada conta, mas temos todas as transações efetuadas. Queremos saber qual saldo total das contas registradas em banco!)
